...
DEFAULT_SPEECH_MODEL = "distil-whisper/distil-large-v3" #"openai/whisper-small"
...
#changed in order to get the "best" performance
DEFAULT_SUMMARY_MODEL = ("bartowski/Phi-3-medium-128k-instruct-GGUF", "Phi-3-medium-128k-instruct-Q6_K_L.gguf") #("QuantFactory/Phi-3-mini-4k-instruct-GGUF", "Phi-3-mini-4k-instruct.Q5_0.gguf")
